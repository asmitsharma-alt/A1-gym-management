...
public final class ItemMemberBinding implements ViewBinding {
  ...
  private ItemMemberBinding(@NonNull MaterialCardView rootView, @NonNull ImageView ivMemberPhoto,
      @NonNull TextView tvExpiryDate, @NonNull TextView tvMemberName,
      @NonNull TextView tvMemberPhone, @NonNull TextView tvStatus) {
  ...
  public static ItemMemberBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMemberBinding((MaterialCardView) rootView, ivMemberPhoto, tvExpiryDate,
          tvMemberName, tvMemberPhone, tvStatus);
    }
